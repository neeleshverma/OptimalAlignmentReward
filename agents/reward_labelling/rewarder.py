...
class OptimalTransportRewarder:
  ...
  def __init__(self,
    ...
    self._compute_rewards = jax.jit(self._compute_ot_rewards)
  ...
  def _compute_ot_rewards(self, params, preprocessor_state, all_expert_atoms,
  ...
  def compute_offline_rewards(self, agent_steps):
    ...
    rewards = self._compute_ot_rewards(self._params, self._preprocessor_state,
                                         self._expert_atoms,
